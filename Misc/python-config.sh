...
CFLAGS=$(echo "-I/opt/boxen/homebrew/include" | sed "s#$prefix_build#$prefix_real#")
VERSION="3.5"
LIBM=""
LIBC=""
SYSLIBS="$LIBM $LIBC"
...
LIBPL=$(echo "NONE/lib/python3.5/config-$(VERSION)$(ABIFLAGS)" | sed "s#$prefix_build#$prefix_real#")
SO="@SO@"
PYTHONFRAMEWORK=""
